    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1">
          <Card className="shadow-lg border-l-4 border-security-accent mb-6 animate-on-scroll">
            <CardContent className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">08/2023 – 05/2025 (Expected)</p>
                </div>
              </div>
            </CardContent>
          </Card>
          
          <Card className="shadow-lg border-l-4 border-security-accent animate-on-scroll">
            <CardContent className="p-6">
              <div className="flex items-start space-x-4">
                <div className="rounded-full bg-security-accent/10 p-3 mt-1">
